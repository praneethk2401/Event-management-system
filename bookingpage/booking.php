...
if(isset($_POST["submit"])){ 
 ...
 $row_eid = mysqli_fetch_array($res_eid);
  ...
  $sql = "INSERT INTO `user_info`.`venue_booking`(`user_name`,`email`, `user_phone`, `venue_id`, `event_id`, `date`, `audience_size`) 
  values ('$name','$email' ,'$phone_number','$venue_id', '$eid','$date','$aud_size');";
 mysqli_query($data, $sql);
  ...
  $sql_equip = "INSERT INTO `user_info`.`equipments`( `chairs_no`, `tables_no`, `lights_no`, `speakers_no`, `microphones_no`, `venue_booking_id`) 
  VALUES ('$chairs','$tables','$lights','$speakers','$microphones','$id' );"   ;
