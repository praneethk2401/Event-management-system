...
<!--Fetching the equipments details from the equipments table -->
...
if(isset($_POST["update"])){
    ...
    $sql_update = "UPDATE `user_info`.`equipments` set `chairs_no`= '$chairs1' , `tables_no`= '$tables1', `speakers_no` = '$speakers1', `lights_no`= '$lights1', 
    `microphones_no`= '$microphones1' where `eid` = '$id' ";
