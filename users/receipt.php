...
<!--Displaying the reciept with event details-->
<div class="container">
    ...
    <div class="card-body">
      ...
      while($row_vb = mysqli_fetch_array($sql_vb) 
       ...
       and $row_event_name = mysqli_fetch_array($res_event_name)
        ...
        $rate = ($row_equipments["chairs_no"] + $row_equipments["tables_no"] + $row_equipments["lights_no"] + $row_equipments["speakers_no"] 
        + $row_equipments["microphones_no"]) * 10 + $row_venue["rate"];
        echo "<p> <b>Total Rate:  </b>"; echo $rate; echo "<hr> </p>";
       }
      ?>
      <center>
        <!--Downloading the receipt in the pdf format-->
