...
if(isset($_POST['save'])){ 
  ...
  while($row = mysqli_fetch_array($res_view)
                        ...
                        $rate = ($row_eq["chairs_no"] + $row_eq["tables_no"] + $row_eq["lights_no"] + 
                        $row_eq["speakers_no"] + $row_eq["microphones_no"]) * 10 + $row_venue["rate"];
...
if(isset($_POST['go'])){ 
  ...
  while($row = mysqli_fetch_array($res_v)
                        ...
                        echo "<p> DATE: " ;echo $row["date"]."</p>" ;
                        echo "<p> AUDIENCE SIZE: " ;echo $row["audience_size"]."</p>" ;
                        $rate = ($row_eq["chairs_no"] + $row_eq["tables_no"] + $row_eq["lights_no"] + $row_eq["speakers_no"] +
                         $row_eq["microphones_no"]) * 10 + $row_venue["rate"];
                        echo "<p> RATE: " ;echo $rate."</p>" ;
                        echo"</td>";
                       echo "<td>";
                       echo "<p> CHAIRS: " ;echo $row_eq["chairs_no"]."</p>" ;
